...
-   **クロスプラットフォーム**: 付属の`Makefile`により、macOS (amd64/arm64)、Linux (amd64/arm64)、Windows (amd64) 向けにビルドできます。Linux・Windows のクロスコンパイルには Podman または Docker が必要です。
